  ...
  <div class="container my-5">
    <div class="row g-4">
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img1.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img2.webp" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="taj.webp" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img4.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img5.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img6.webp" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img7.jpg" class="card-img-top" alt="Placeholder">
          <div class="card-body">
      ...
      <div class="col-6 col-md-3">
        <div class="card">
          <img src="img8.webp" class="card-img-top" alt="Placeholder">
          <div class="card-body">
...
## OUTPUT:
![Web_Project](https://github.com/user-attachments/assets/d1af83d7-cc68-4957-8f67-96fe8057f92e)
